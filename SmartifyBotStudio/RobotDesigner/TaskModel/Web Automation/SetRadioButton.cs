...
{
    [Serializable]
    public class SetRadioButton : RobotActionBase, ITask
    {
        ...
        public ObservableCollection<HtmlElementInfo> SetRadioButton_HtmlElemtnInfo_list { get; set; }
        ...
        public int Execute()
        {
            try
            {
                ...
                for (int i = 0; i < SetRadioButton_HtmlElemtnInfo_list.Count; i++)
                {


                    if (SetRadioButton_HtmlElemtnInfo_list[i].Html_element_id != "")
                    {
                        element = working_driver.FindElement(By.Id(SetRadioButton_HtmlElemtnInfo_list[i].Html_element_id));
                    }
                    else if (SetRadioButton_HtmlElemtnInfo_list[i].Html_element_XPATH != "")
                    {
                        element = working_driver.FindElement(By.XPath(SetRadioButton_HtmlElemtnInfo_list[i].Html_element_XPATH));
                    }
                    else
                    {
                        element = working_driver.FindElement(By.Name(SetRadioButton_HtmlElemtnInfo_list[i].Html_element_name));
                    }
                    ...
                    //selectElement.SelectByIndex(SetRadioButton_HtmlElemtnInfo_list[i].Html_drop_down_index);
